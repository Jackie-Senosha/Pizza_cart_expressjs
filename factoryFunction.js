module.exports = function cart() {
    ...
    function priceUpdate() {
        smallCost = (smallQty * 49.00).toFixed(2);
        medCost = (medQty * 89.00).toFixed(2);
        largeCost = (largeQty * 120.00).toFixed(2);
        totalCart = (smallQty * 49.00 + medQty * 89.00 + largeQty * 120.00).toFixed(2);
